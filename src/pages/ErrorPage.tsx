      ...
      <div className="flex flex-col justify-center items-center h-5/5">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
          <div className=" flex flex-row mt-35 mb-8">
            ...
            <p className="text-white text-2xl mt-auto font-[DungGeunMo]">
              지금은 곤란하다,
              <br />
              다시 시도해달라.
            </p>
          </div>
          <button className="bg-contain bg-center text-red-500 font-[DungGeunMo] text-4xl flex items-center justify-center ml-23">
